...
<head>
	...
	<title>Rental | Admin Update Gambar 1</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gambar 1 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">DetailGambar 1</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Gambar1 Saat Ini</label>
<?php 
$id=intval($_GET['imgid']);
