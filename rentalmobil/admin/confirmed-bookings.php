...
<head>
	...
	<title>Rental | Rental Terkonfirmasi   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Rental Terkonfirmasi</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Info Rental</div>
...
echo htmlentities('Terkonfirmasi');
}
 else{
...
<a href="bookig-details.php?bid=<?php echo htmlentities($result->id);?>"> Tampilan</a>
</td>
