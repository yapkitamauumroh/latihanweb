...
<head>
	...
	<title>Rental | Admin Edit Info Mobil</title>
...
<?php if($msg){?><div class="succWrap"><strong>BERHASIL</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Mobil<span style="color:red">*</span></label>
<div class="col-sm-4">
