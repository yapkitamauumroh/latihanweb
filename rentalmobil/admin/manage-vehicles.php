...
$query -> execute();
$msg=" Data Mobil Telah Berhasil Dihapus";
}
...
<head>
	...
	<title>Rental |Admin Manage Mobil   </title>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Apakah Anda Yakin?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
