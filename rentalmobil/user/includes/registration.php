            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                <div class="form-group">
                  <input type="text" class="form-control" name="fullname" placeholder="Nama Panjang" required="required">
                </div>
                      <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Nomor Telepon" maxlength="12" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">Saya Setuju <a href="#">Terms and Conditions</a></label>
                </div>
                <div class="form-group">
